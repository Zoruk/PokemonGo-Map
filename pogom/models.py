...
def create_tables(db):
    ...
    db.create_tables([Pokemon, LurePokemon, Pokestop, Gym, ScannedLocation, MainWorker, WorkerStatus], safe=True)
    db.close()


def drop_tables(db):
    db.connect()
    db.drop_tables([Pokemon, LurePokemon, Pokestop, Gym, ScannedLocation, MainWorker, WorkerStatus, Versions], safe=True)
    db.close()
